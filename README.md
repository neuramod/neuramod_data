...
##### - openbis
* `002_fromRawDatasetToRawBidsFormat.ipynb`: a script that assign events, data slicing w.r.t photodiode.csv cutoff value, conversion of raw data to brainvision file format and fterwards converting the raw dataset into BIDS format.
#### - Streaming
