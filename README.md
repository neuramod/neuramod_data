...
#### - Processing
##### - local
* `000_csvtoedfconversion.py`: a script that convert csv to edf file format for previewing recorded raw data for visula inspection [Link](https://github.com/neuramod/neuramod_data/blob/main/code/README.md)
